...
func TestJSONMarshal(t *testing.T) {
	t.Run("3 digit marshal", func(t *testing.T) {
	...
	t.Run("4 digit marshal", func(t *testing.T) {
		versionString := "3.1.4.5-alpha.1.5.9+build.2.6.5"
		v, err := Parse(versionString)
		if err != nil {
			t.Fatal(err)
		}
...
func TestJSONUnmarshal(t *testing.T) {
	t.Run("3 digit unmarshal", func(t *testing.T) {
		versionString := "3.1.4-alpha.1.5.9+build.2.6.5"
		quotedVersionString := strconv.Quote(versionString)
	...
	t.Run("4 digit unmarshal", func(t *testing.T) {
		versionString := "3.1.4.5-alpha.1.5.9+build.2.6.5"
		quotedVersionString := strconv.Quote(versionString)
